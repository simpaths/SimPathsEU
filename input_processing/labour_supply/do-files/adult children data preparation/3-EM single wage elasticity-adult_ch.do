...
*run EM to get the ils_dispy for sample of adult children resulting from a 10% increase in gross wage 
************************************************************************
...
//update 1/2/2021: when Extract the sample of "singles" and define variables, save separately as sim_singles_indep_110_IT_individuals_output_wage`i'-dropped_sample 
//& sim_singles_dep_110_IT_individuals_output_wage`i'-dropped_sample
...
merge 1:1 idperson using temp_file-dropped_sample.dta												//add additional information
drop _merge
...
save sim_110_individuals_output_wage`i'-dropped_sample,replace
...
foreach i in 1 2{   //loop begin for wage imputation method 
//local i=1
use "sim_110_individuals_output_wage`i'-dropped_sample",clear
merge 1:1 idperson using "singles_wage`i'-dropped_sample.dta"
keep if _merge==3
drop _merge
su hhcon sim_hhcon
...
drop sim_*
gen sim_flag=1
//sim_singles_indep_110_individuals_output_wage`i'-dropped_sample 
preserve
keep if temp_singles_indep==1 & temp_adultchildflag==1 
save "sim_singles_indep_110_individuals_output_wage`i'-dropped_sample",replace
restore

//sim_singles_dep_110_individuals_output_wage`i'-dropped_sample
preserve
keep if temp_singles_dep==1
save "sim_singles_dep_110_individuals_output_wage`i'-dropped_sample",replace
restore

//save sim_singles_110_individuals_output_wage`i'-dropped_sample,replace
}  //loop end for wage imputation method
